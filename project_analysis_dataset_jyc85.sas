...
proc sgplot data=freqcount2;
	series x=date1year y=count / group=general_reason markers markerattrs=(size=5pt);
	label count='Number of recalls';
	label date1year = 'Year';
	yaxis grid values=(0 to 150 by 5);
run;

proc sgplot data=freqcount3;
	series x=date1year y=count / group=initial_firm_notification markers markerattrs=(size=5pt);
	label count='Number of recalls';
	label date1year = 'Year';
	yaxis grid values=(0 to 100 by 5);
run;

proc sgplot data=freqcount4 ;
	series x=date1year y=count / group=classification name="class" markers markerattrs=(size=5pt);
	label count='Number of recalls';
	label date1year = 'Year';
...
proc sgplot data=freqcount5 ;
	series x=date1year y=count / group=voluntary_mandated markers markerattrs=(size=5pt);
	label count='Number of recalls';
	label date1year = 'Year';
